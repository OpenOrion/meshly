...
class JsonSchemaProperty(BaseModel):
    ...
    additionalProperties: JsonSchemaProperty | bool | None = None
    ...
    def get_inner_type(self) -> JsonSchemaProperty | None:
...
class JsonSchema(BaseModel):
    ...
    additionalProperties: bool | JsonSchemaProperty | None = None
    """Whether additional properties are allowed."""
    
    model_config = {"extra": "allow", "populate_by_name": True}
    
    def get_property(self, name: str) -> JsonSchemaProperty | None:
    ...
    def resolve_ref(self, ref: str) -> JsonSchemaProperty | None:
    ...
    def get_resolved_property(self, name: str) -> JsonSchemaProperty | None:
