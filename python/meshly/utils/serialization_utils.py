...
class SerializationUtils:
    ...
    @staticmethod
    def _encode_array_to_ref(value: object, encoding: ArrayEncoding = "array") -> ExtractedResult:
    ...
    def extract_value(value: object) -> ExtractedResult:
        ...
        if ArrayUtils.is_array(value):
            return SerializationUtils._encode_array_to_ref(value)
    ...
    def extract_basemodel(value: BaseModel, include_computed: bool = False) -> ExtractedResult:
        ...
        for name in all_fields:
            ...
            if ArrayUtils.is_array(field_value):
                ...
                result = SerializationUtils._encode_array_to_ref(field_value, encoding)
